 ...
 */
export function encryptDataKey(dek) {
 ...
 */
export function decryptDataKey(encryptedDek) {
    const kek = getMasterKey();
 ...
 */
export function encryptData(plaintext, dek, keyId, keyVersion) {
    const iv = crypto.randomBytes(IV_LENGTH);
 ...
 */
export function decryptData(encryptedData, dek) {
 ...
 */
export function encryptToken(token, dek, keyId, keyVersion = 1) {
 ...
 */
export function decryptToken(encryptedString, dek) {
    ...
    const token = decryptData({ ciphertext, iv, authTag, keyVersion, keyId }, dek);
 ...
 */
export function rotateEncryption(encryptedString, oldDek, newDek, newKeyId, newKeyVersion) {
 ...
 */
export function createShortHash(data) {
