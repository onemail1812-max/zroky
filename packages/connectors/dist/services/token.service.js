 ...
 */
import { encryptToken, decryptToken, generateDataKey, encryptDataKey, decryptDataKey } from './encryption.service.js';
...
export class TokenService {
    ...
    dekCache = new Map();
    DEK_CACHE_TTL = 5 * 60 * 1000; // 5 minutes
     ...
     */
    async storeTokens(accountId, tenantId, tokens) {
     ...
     */
    async getTokens(accountId, tenantId) {
     ...
     */
    async refreshTokensWithLock(accountId, tenantId, refreshFn) {
     ...
     */
    async waitForRefresh(accountId, tenantId, maxWait = 5000) {
